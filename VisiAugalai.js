              ...
              <View style={styles.modalContainer}>
                {selectedPlant && (
                  <View style={styles.modalContent}>
                    <Text style={styles.nameText}>{selectedPlant.name}</Text>
                    <Text> </Text>
                    <Text style={styles.dataText}>{selectedPlant.description}</Text>
                    <Text style={styles.otherText}>Laistymas</Text>
                    <Text style={styles.dataText}>{selectedPlant.wateringInstructions}</Text>
                    <Text style={styles.otherText}>Kur augalą laikyti?</Text>
